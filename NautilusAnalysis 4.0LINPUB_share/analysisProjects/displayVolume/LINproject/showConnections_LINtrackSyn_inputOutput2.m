...
rotDir = 'C:\Users\jlmorgan\Documents\LIN\images\inputOutput_21\';
...
fromRGC_dat = dsAnchors(synPos.postRGCPos,obI,[2 1 3])*4;
...
synType = {  'bar'      'bar'       'ring'       'ring'      'ring'      'x'};
synCol = [   0 1 0;    .2 .2 1;    1 0 1;      1 0 0;     .2 .2 1;     .4 .6 2];
var1 = [    32          32          32          32          32          30];
var2 = [    5           5           5           5           5          30]
