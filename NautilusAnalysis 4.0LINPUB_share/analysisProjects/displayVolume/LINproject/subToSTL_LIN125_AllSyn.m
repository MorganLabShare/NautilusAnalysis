...
obMovDir = 'D:\LGNs1\Analysis\movies\subLin125_Region1_NoSyn1_n2_b\'
if ~exist(obMovDir,'dir'),mkdir(obMovDir),
else
...
crop = [1 1 1; max(cat(1, dsObj.subs))]
...
for i = 1:length(az);
    ...
    lightangle(l,az(i)+10+startAngle(1),startAngle(2)+70)
    %lightangle(l,82.4,110)
    pause(.01)
    axis off
